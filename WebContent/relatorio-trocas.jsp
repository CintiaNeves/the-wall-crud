...
<head>
	...
	<title>The Wall - Relatório de Trocas</title>
	...
	<script type="text/javascript">
		...
		function drawCharts() {
			graficoColunas("Instrumentos trocados no período", "line_chart_div", { operacao: "CONSULTAR", relatorio: "TROCAS", retornoJson: true });
		}
