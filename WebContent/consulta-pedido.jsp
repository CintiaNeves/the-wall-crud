...
<title>The Wall - Consulta de Pedidos</title>
							...
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach var="pedido" items="${pedidos}">
										<tr style="text-align: center;">
											<td style="padding-top: 19px;">${pedido.numero}</td>
											<td style="padding-top: 19px;">${pedido.cliente.nome}</td>
											<td style="padding-top: 19px;">${pedido.data}</td>
											<td style="padding-top: 19px;">${pedido.total}</td>
											<td style="padding-top: 19px;">${pedido.status.descricao}</td>
