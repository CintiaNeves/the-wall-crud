...
import br.com.les.thewallcrud.viewhelper.VHPaisCobranca;
...
public class PaisController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		IViewHelper vhPais = new VHPaisCobranca();
		EntidadeDominio entidade = vhPais.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhPais.setView(resultado, request, response);
	}
