...
import br.com.les.thewallcrud.viewhelper.VHItemCarrinho;

@WebServlet(urlPatterns = {"/itemCarrinho"})
@SuppressWarnings("serial")
public class ItemCarrinhoController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		EntidadeDominio entidade = vhItemCarrinho.getEntidade(request);
		Resultado resultado = command.executar(entidade);
 		vhItemCarrinho.setView(resultado, request, response);
	}
