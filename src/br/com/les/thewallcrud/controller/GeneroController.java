...
import br.com.les.thewallcrud.viewhelper.VHGenero;

@WebServlet(urlPatterns = {"/genero"})
...
public class GeneroController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		EntidadeDominio entidade = vhGenero.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhGenero.setView(resultado, request, response);
	}
