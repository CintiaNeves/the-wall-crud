...
import br.com.les.thewallcrud.viewhelper.VHBandeira;

@WebServlet(urlPatterns = {"/bandeira"})
@SuppressWarnings("serial")
public class BandeiraController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		IViewHelper vhBandeira = new VHBandeira();
		EntidadeDominio entidade = vhBandeira.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhBandeira.setView(resultado, request, response);
	}
