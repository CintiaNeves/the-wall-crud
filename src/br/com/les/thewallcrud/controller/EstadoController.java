...
import br.com.les.thewallcrud.viewhelper.VHEstadoCobranca;
...
public class EstadoController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		IViewHelper vhEstado = new VHEstadoCobranca();
		EntidadeDominio entidade = vhEstado.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhEstado.setView(resultado, request, response);
	}
