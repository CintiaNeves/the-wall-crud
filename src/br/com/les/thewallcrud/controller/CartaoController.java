...
import br.com.les.thewallcrud.viewhelper.VHCartao;

@WebServlet(urlPatterns = {"/cartao"})
...
public class CartaoController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		IViewHelper vhCartao = new VHCartao();
		EntidadeDominio entidade = vhCartao.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhCartao.setView(resultado, request, response);
	}
