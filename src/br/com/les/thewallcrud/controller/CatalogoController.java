...
import br.com.les.thewallcrud.viewhelper.VHCatalogo;
...
public class CatalogoController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		IViewHelper vhCatalogo = new VHCatalogo();
		EntidadeDominio entidade = vhCatalogo.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhCatalogo.setView(resultado, request, response);
	}
