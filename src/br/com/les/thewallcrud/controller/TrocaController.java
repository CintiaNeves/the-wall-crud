...
import br.com.les.thewallcrud.viewhelper.VHTroca;

@WebServlet(urlPatterns = {"/troca"})
...
public class TrocaController extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		IViewHelper vhTroca = new VHTroca();
		EntidadeDominio entidade = vhTroca.getEntidade(request);
		Resultado resultado = command.executar(entidade);
		vhTroca.setView(resultado, request, response);
	}
}
